<template>
  <div class="h-full p-0 pt-0 sm:p-4">
    ...
    >
      รายการจองคิวล่วงหน้า
      <div
        class="mt-3 sm:text-left sm:justify-between sm:w-full md:w-full lg:w-3/5 sm:flex text-center items-center justify-center"
      >
        <div class="relative text-lg z-20">
          <button
            class="flex items-center justify-between px-3 py-1 bg-white w-full sm:w-[14.5vh] md:w-[18vh] lg:w-[20vh] border border-[#2BADCF] rounded-[30px]"
        ...
        <div class="relative text-lg z-10 mt-5 sm:mt-0">
          <button
            class="flex items-center justify-between px-3 py-1 bg-white w-full sm:w-[14.8vh] md:w-[18vh] lg:w-[20vh] border border-[#2BADCF] rounded-[30px]"
          ...
          >
            <ul
              ...
              class="absolute left-0 right-0 mb-4 bg-white divide-y rounded-lg shadow-lg overflow-hidden cursor-pointer"
            >
              <li
        ...
        <div class="relative text-lg mt-5 sm:mt-0">
          <div
            class="flex items-center px-3 py-1 bg-white w-full sm:w-[14.5vh] md:w-[18vh] lg:w-[20vh] border border-[#2BADCF] rounded-[30px]"
          >
            <input
              type="text"
              placeholder="ค้นหา"
